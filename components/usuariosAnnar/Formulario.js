...
const Formulario = () => {
  ...
  const [diseño, setDiseño] = useState('5');
  const [tamaño, setTamaño] = useState('5');
  const [facilidadDeUso, setFacilidadDeUso] = useState('5');
  const [calidadDeAgua, setCalidadDeAgua] = useState('5');
  ...
  const [presentacionPersonalSAT, setPresentacionPersonalSAT] = useState('5');
  const [amabilidadSAT, setAmabilidadSAT] = useState('5');
  const [conocimientoSAT, setConocimientoSAT] = useState('5');
  const [asesoriaSAT, setAsesoriaSAT] = useState('5');
  const [tiempoSAT, setTiempoSAT] = useState('5');
  ...
  const [tiempoDeRespuestaWp, setTiempoDeRespuestaWp] = useState('5');
  const [amabilidadWp, setAmabilidadWp] = useState('5');
  const [empatiaWp, setEmpatiaWp] = useState('5');
  const [conocimientoWp, setConocimientoWp] = useState('5');
  const [asesoriaWp, setAsesoriaWp] = useState('5');
  const [solucionWp, setSolucionWp] = useState('5');
  const [disponibilidadWp, setDisponibilidadWp] = useState('5');
